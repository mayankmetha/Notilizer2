...
import com.mayank.notilizer2.NotificationAppViewAdapter;
...
public abstract class HistoryFragment extends Fragment {
    ...
    public HistoryFragment() {
        this.paintWhite.setColor(Color.rgb(255,207,74));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chart.setValueTextColor(Color.rgb(255,207,74));
    ...
    public void onResume() {
        ...
        try {
            ...
            dataSet.setColors(ColorTemplate.GOLD);
            chart.setData(data);
