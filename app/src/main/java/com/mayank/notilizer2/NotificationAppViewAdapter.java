...
public class NotificationAppViewAdapter extends ArrayAdapter<NotificationAppView> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.progressBar.getProgressDrawable().setColorFilter(Color.parseColor("#ffcf4a"), PorterDuff.Mode.SRC_IN);
        holder.progressBar.getIndeterminateDrawable().setColorFilter(Color.parseColor("#ffcf4a"),PorterDuff.Mode.SRC_IN);
